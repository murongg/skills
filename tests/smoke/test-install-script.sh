...
if [ ! -f "$TEST_HOME/.agents/skills/my-skills/git-commit-message/SKILL.md" ]; then
    echo "[FAIL] central my-skills install does not include the git-commit-message skill"
    exit 1
fi

if [ ! -f "$TEST_HOME/.agents/skills/my-skills/git-branch-management/SKILL.md" ]; then
    echo "[FAIL] central my-skills install does not include the git-branch-management skill"
    exit 1
fi
...
if [ ! -f "$TEST_HOME/.agents/skills/my-skills/monorepo-structure/SKILL.md" ]; then
    echo "[FAIL] central my-skills install does not include the monorepo-structure skill"
    exit 1
fi
